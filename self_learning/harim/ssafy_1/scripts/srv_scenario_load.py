...
def srv_client():
    ...
    scenario_setting.delete_all                     = 맵 초기화
    scenario_setting.load_ego_vehicle_data          = 내 차 종류
    scenario_setting.load_surrounding_vehicle_data  = 맵 데이터의 다른차량
    scenario_setting.load_pedestrian_data           = 보행자
    scenario_setting.load_obstacle_data             = 장애물
    scenario_setting.set_pause                      = 정지해있을지

    '''
    scenario_setting = ScenarioLoad()
    scenario_setting.file_name                      = "ssafy_scenario.json"
    ...
    scenario_setting.load_pedestrian_data           = False
